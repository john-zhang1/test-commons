...
public class Navigation extends AbstractDSpaceTransformer implements CacheableProcessingComponent {
            ...
            AuthorizeException
    {
        ...
        String tagManagerKey = DSpaceServicesFactory.getInstance().getConfigurationService().getProperty("xmlui.google.tagmanager.key");
        if (tagManagerKey != null && tagManagerKey.length() > 0)
        {
                tagManagerKey = tagManagerKey.trim();
                pageMeta.addMetadata("google","tagmanager").addContent(tagManagerKey);
        }
